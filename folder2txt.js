...
function alreadyHasHeader(content) {
  // Look at the first line; handle Windows or Unix line endings
...
function processFolder({ folderPath, outputPath, lang = 'en' }) {
  ...
  // Create the directories for outputPath if they don't exist
  ...
  function processFile(filePath) {
    ...
    // Only write a new header if it doesn't already have one
